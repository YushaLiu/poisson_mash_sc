---
title: "Application of poisson mash ruv to CD4 T cells in single cell cytokines data"
author: "Yusha Liu"
header-includes:
date: "2021-4-21"
...
## Summary
We apply poisson mash ruv to a subset of CD4 T cells from a single cell cytokines dataset, where the conditions represent different types of cytokine treatments ($R=46$). This dataset includes expression data of $J=10,122$ genes from $9,499$ cells. Genes with fewer than $25$ counts summed over all cells are removed. 
...
fit.ed <- readRDS("../applications_sc/CD4/pois_mash_ruv_ed.Rds")
...
res <- readRDS("../applications_sc/CD4/pois_mash_ruv_fit.Rds")
...
data <- readRDS("../applications_sc/CD4/data_jr.Rds")
