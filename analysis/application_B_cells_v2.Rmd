...
```
The ELBO peaks at $\epsilon^2$ = 1.8e-5, and the largest ELBO is -171230.3. For $\epsilon^2$ = 1.4e-3, ELBO is -171263.0. For $\epsilon^2$ = 1.3e-2, ELBO is -171313.8. However, we found that adding an $\epsilon^2 \le$ 1e-4 doesn't seem to effectively solve the tight error bar issue. 
