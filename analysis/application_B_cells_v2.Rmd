...
for(l in 1:20){
  fit.ed.l <- readRDS(paste0("../applications_sc/B_cells/epsilon2_estimation/pois_mash_ruv_ed_", l, ".Rds"))
...
```
The ELBO peaks at $\epsilon^2 = 1.8e-5$, and the largest ELBO is -171230.3. For $\epsilon^2 = 1.4e-3$, ELBO is -171263.0. For $\epsilon^2 = 1.3e-2$, ELBO is -171313.8. However, we found that adding an $\epsilon^2 \approx 1e-4$ doesn't seem to effectively solve the tight error bar issue. 
...
pois.ruv.v1 <- readRDS("../applications_sc/B_cells/pois_mash_ruv_posterior_v3.Rds")
pois.ruv.v2 <- readRDS("../applications_sc/B_cells/pois_mash_ruv_posterior_v5.Rds")
...
plot_by_gene(data=data.jr, s=s, res.pois1=pois.ruv.v1, res.pois2=pois.ruv.v2, res.mash=mash.cb$result, genename="Vim", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois1=pois.ruv.v1, res.pois2=pois.ruv.v2, res.mash=mash.cb$result, genename="Ahnak", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois1=pois.ruv.v1, res.pois2=pois.ruv.v2, res.mash=mash.cb$result, genename="Lgals1", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois1=pois.ruv.v1, res.pois2=pois.ruv.v2, res.mash=mash.cb$result, genename="Lmo7", cols.trt=cols.trt)
...
plot_by_gene(data=data.jr, s=s, res.pois1=pois.ruv.v1, res.pois2=pois.ruv.v2, res.mash=mash.cb$result, genename="Lgals3bp", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois1=pois.ruv.v1, res.pois2=pois.ruv.v2, res.mash=mash.cb$result, genename="Parp9", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois1=pois.ruv.v1, res.pois2=pois.ruv.v2, res.mash=mash.cb$result, genename="Mndal", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois1=pois.ruv.v1, res.pois2=pois.ruv.v2, res.mash=mash.cb$result, genename="Sp100", cols.trt=cols.trt)
