...
```
The ELBO peaks at $\epsilon^2 = 7.8e-5$, and the largest ELBO is -333039.4. For $\epsilon^2 = 1.4e-3$, ELBO is -333082.6. For $\epsilon^2 = 1.3e-2$, ELBO is -333510.4. However, we found that adding an $\epsilon^2 \approx 1e-4$ doesn't seem to effectively solve the tight error bar issue. 
