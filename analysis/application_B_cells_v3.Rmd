...
## Summary
We apply poisson mash ruv to a subset of B cells from a single cell cytokines dataset, where the conditions represent different types of cytokine treatments ($R=46$). This dataset includes expression data of $J=10,150$ genes from $9,405$ cells. Genes with fewer than $25$ counts summed over all cells are removed. 
...
res <- readRDS("../applications_sc/B_cells/pois_mash_ruv_fit_v5.Rds")
...
## A few examples (in GO:0035456: response to interferon-beta)
```{r warning=FALSE, message=FALSE}
...
plot_by_gene(data=data.jr, s=s, res.pois=pois.ruv, genename="Bst2", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois=pois.ruv, genename="Gbp2", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois=pois.ruv, genename="Gbp3", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois=pois.ruv, genename="Ifi203", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois=pois.ruv, genename="Ifi47", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois=pois.ruv, genename="Ifit1", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois=pois.ruv, genename="Ifit1bl1", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois=pois.ruv, genename="Ifit3", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois=pois.ruv, genename="Ifit3b", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois=pois.ruv, genename="Ifitm3", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois=pois.ruv, genename="Igtp", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois=pois.ruv, genename="Irf1", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois=pois.ruv, genename="Irgm1", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois=pois.ruv, genename="Mndal", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois=pois.ruv, genename="Tgtp2", cols.trt=cols.trt)
plot_by_gene(data=data.jr, s=s, res.pois=pois.ruv, genename="Xaf1", cols.trt=cols.trt)
